...
import { SIGNAL_FEED, REASONING_STEPS, HERO_SIGNAL, CANDLES, buildSpark } from './data';
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10, marginBottom: 12 }}>
                  <StatItem label="Risk" value="–11.4" unit="pips" color="var(--orange)"/>
                  <StatItem label="Reward" value="+31.2" unit="pips" color="var(--green)"/>
