...
export function Sparkline({ data, color = 'var(--ink-2)', width = 120, height = 36, fill = true }) {
...
export function ConfidenceRing({ value, size = 120, stroke = 8, label = 'CONFIDENCE', color = 'var(--orange)' }) {
...
export function ConfidenceBar({ value, color = 'var(--orange)', height = 6, showValue = true }) {
  const ref = useRef(null);
...
export function Typewriter({ text, speed = 18, startDelay = 0, onDone, className = '', style = {} }) {
...
export function CountUp({ value, duration = 1400, decimals = 0, prefix = '', suffix = '', className = '', style = {} }) {
...
export function BiasBadge({ bias, confidence }) {
  const map = {
...
export function Waveform({ bars = 32, color = 'var(--orange)', height = 28 }) {
